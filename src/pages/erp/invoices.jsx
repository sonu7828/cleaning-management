                                        ...
                                        <td className="py-3.5 px-2 text-right space-x-1.5 whitespace-nowrap">
                                            ...
                                            {inv.status !== 'Paid' && isBillingStaff && (
                                                <button
                                                    ...
                                                    className="px-2 py-1 bg-success hover:bg-[#059669] text-white rounded-lg font-bold transition shadow-sm"
                                                >
                                                    Record Payment
                                                </button>
                                            )}
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm">
                    <div className="relative bg-white border border-slate-200 rounded-2xl p-6 w-full max-w-md shadow-2xl z-10 space-y-4 text-slate-700">
                        ...
                        <form onSubmit={handleRecordPaymentSubmit} className="space-y-3.5 text-xs">
                            ...
                            <div className="space-y-1">
                                <label className="font-bold text-slate-500 block mb-1">Payment Amount (AED) *</label>
                                <input 
                                    type="number" 
                                    step="0.01"
                                    required 
                            ...
                            <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
                                ...
                                <button type="submit" className="px-4 py-2 bg-success text-white rounded-xl font-bold hover:bg-[#059669]">Record Receipt</button>
                            </div>
                        </form>
                    </div>
                </div>
